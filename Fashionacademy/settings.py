"""
Django settings for Fashionacademy project.
...
SECRET_KEY = 'django-insecure-=z_xe&_k4=n0@)n)%3h!zqm3np)z=uougq55tjilz535prg(^x'
...
ROOT_URLCONF = 'Fashionacademy.urls'
...
WSGI_APPLICATION = 'Fashionacademy.wsgi.application'
